...
| Page | Description |
| :--- | :--- |
| [Initial Setup](docs/Install-Setup.md) | Step-by-step guide for setting up the hardware (RP2040, CANable) and installing the required software (Python Backend, Node.js Frontend). |
